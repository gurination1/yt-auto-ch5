...
def vision_rank_broll(
    ...
    prompt_text = (
        ...
        f"   - STATIONARY 3D STOCK RENDERS: ZERO-SCORE REJECT completely stationary 3D rendered pill bottles, medicine jars, or generic spinning DNA helices floating in dark void.\n"
